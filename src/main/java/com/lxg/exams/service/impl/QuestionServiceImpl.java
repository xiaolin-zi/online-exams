...
public class QuestionServiceImpl extends ServiceImpl<QuestionMapper, Question>
    ...
    public int addQuestion(String title, String optionA, String optionB, String optionC, String optionD, String answer, int types, String image, String remark, int uid) {
        ...
        //isDelete默认为0，不需要传入
        //isPublic默认为0，不需要传入
        Question question = new Question(null,title,optionA,optionB,optionC,optionD,answer,types,image,remark,null,uid,null,null,null,null,null,null,null);
    ...
    @Override
    public List<Map<String, Object>> getQuestionCountByDate(int uid) {
        List<Map<String, Object>> questionCountByDate = questionMapper.getQuestionCountByDate(uid);
        return questionCountByDate;
    }
