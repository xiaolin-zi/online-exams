...
public class WebIATWSUtils extends WebSocketListener {
	...
	private static final String appid = "db0e7258"; //在控制台-我的应用获取
	private static final String apiSecret = "NjZmMDNiMzZlN2FkZTQxNWU0NWIzMzQ1"; //在控制台-我的应用-语音听写（流式版）获取
	private static final String apiKey = "415a5eba205fb76b487ee89f471b02e3"; //在控制台-我的应用-语音听写（流式版）获取
